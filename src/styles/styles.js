const styles = {
    ...
    active_indicator:"absolute bottom-[-27%] left-0 h-[3px] w-full bg-orange-600",
    button: 'bg-transparent border p-3 hover:border-red-600 hover:text-red-600 duration-300 cursor-pointer',
