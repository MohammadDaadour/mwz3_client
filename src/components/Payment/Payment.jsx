...
const Payment = () => {
  ...
  return (
    <div dir="rtl" className="w-full flex flex-col items-center py-8 bg-white">
    ...
    <div dir="rtl" className="w-full 800px:w-[95%] bg-white rounded-md p-5 pb-8">
      ...
      <div>
        <div className="flex w-full pb-5 border-b mb-2">
          ...
          <h4 className="text-[18px] pr-2 font-[600] text-[#000000b1]">
            الدفع عند الاستلام
          </h4>
        </div>
          ...
          <div className="w-full flex">
            <form className="w-full" onSubmit={cashOnDeliveryHandler}>
              <input
                type="submit"
                value="التالي"
                className={` bg-red-600 hover:bg-red-800  text-[#fff] duration-200 px-8 py-2 cursor-pointer text-[18px] font-[600]`}
              />
            </form>
          </div>
        ) : null}
