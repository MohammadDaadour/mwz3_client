...
const CartSingle = ({ data,removeFromWishlistHandler,addToCartHandler }) => {
  ...
  return (
    <div className="border-b p-4">
      <div className="w-full flex 800px:flex items-center justify-between">
        <img
        ...
        <div className="flex">
          ...
          className="w-[25px] mr-2 cursor-pointer"
          src={recyclebin}
          alt=""
        />
        </div>
